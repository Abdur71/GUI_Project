...
def update_progress():
    ...
    window.after(100, update_progress)  # Schedule the next update
...
l_music_player = tk.Label(window, text="Music Player", font=("TkDefaultFont", 30, "bold"), bg="black", fg="white")
...
lbox = tk.Listbox(window, width=50, font=("TkDefaultFont", 16), bg="black", fg="white", selectbackground="orange", selectforeground="black")
lbox.pack(pady=10)

# Create a frame to hold the control buttons
btn_frame = tk.Frame(window)
btn_frame.pack(pady=20)
btn_frame.config(bg="black")
